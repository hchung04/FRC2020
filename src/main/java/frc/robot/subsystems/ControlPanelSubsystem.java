...
public class ControlPanelSubsystem extends SubsystemBase {
   ...
   */
  private final PWMTalonSRX panelController = new PWMTalonSRX(AutoConstants.controlPanelport);
  ...
  private final Encoder m_Encoder = new Encoder(4,5,true);
